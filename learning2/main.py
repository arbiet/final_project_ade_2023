...
def extract_features(image_path):
    ...
    # Langkah 1: Ekstraksi Histogram Warna
    ...
    color_feature = np.concatenate([hist_hue.flatten(), hist_saturation.flatten(), hist_value.flatten()])
...
new_image_paths = ["test/kering_2.jpg", "test/matang_6.jpg", "test/busuk_19.jpg", "test/kehijauan_1.jpg", "test/matang_1.jpg", "test/matang_2.jpg", "test/matang_3.jpg", "test/matang_4.jpg", "test/matang_5.jpg"]
new_data = []
dummy_true_labels = [3, 4, 1, 2, 4, 4, 4, 4, 4]  # Sesuaikan dengan label sebenarnya citra uji
